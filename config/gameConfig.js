...
export const gameConfig = {
  ...
  combat: {
    targetScanIntervalMs: 120,
    attackCooldownMs: 1450,
    maxPlayers: 200,
    idleWanderTurnChance: 0.06,
    attackContactScale: 1.08,
    giantSlayerBonusHpStep: 500,
    giantSlayerMaxBonus: 12,
    wanderDurationMs: [650, 1250],
    attackDurationMs: [1800, 3600],
    engageChance: 0.62,
    engageRadiusMultiplier: 7,
    postCollisionWanderMs: [360, 760],
    collisionDamageMinSpeed: 220,
    collisionDamageCooldownMs: 1200
  },
  physics: {
    friction: 0.989,
    steering: 0.13,
    orbitStrength: 0.72,
    collisionBounce: 1.22,
    collisionPush: 0.46,
    hitKnockback: 430,
    attackerRecoil: 150,
    maxVelocity: 920,
